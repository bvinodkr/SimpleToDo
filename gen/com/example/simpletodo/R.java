...
containing a value of this type.
 ...
 The platform's desired fixed width for a dialog along the minor axis
    ...
    public static final class id {
        public static final int IvItems=0x7f05003f;
        ...
        */
        ...
        /**  These attributes are meant to be specified and customized by the app.
         ...
         be present and whether it should overlay content. 
           ...
           <tr><td><code>{@link #ActionBarWindow_windowFixedHeightMajor com.example.simpletodo:windowFixedHeightMajor}</code></td><td> A fixed height for the window along the major axis of the screen,
             that is, when in portrait.</td></tr>
           <tr><td><code>{@link #ActionBarWindow_windowFixedHeightMinor com.example.simpletodo:windowFixedHeightMinor}</code></td><td> A fixed height for the window along the minor axis of the screen,
             that is, when in landscape.</td></tr>
           <tr><td><code>{@link #ActionBarWindow_windowFixedWidthMajor com.example.simpletodo:windowFixedWidthMajor}</code></td><td> A fixed width for the window along the major axis of the screen,
             that is, when in landscape.</td></tr>
           <tr><td><code>{@link #ActionBarWindow_windowFixedWidthMinor com.example.simpletodo:windowFixedWidthMinor}</code></td><td> A fixed width for the window along the minor axis of the screen,
             that is, when in portrait.</td></tr>
